...
const voiceRSS="use strict";
let VoiceRSS={speech:function(e){this._validate(e),this._request(e)},
        ...
        _request:function(e) {
            ...
            t.onreadystatechange=function() {
                if(4==t.readyState&&200==t.status) {
                    if(0==t.responseText.indexOf("ERROR"))throw t.responseText;new Audio(t.responseText).play()}
                },
...
function test() {
    VoiceRSS.speech({
            key: '<6395e6087569469c9b2640feb00fd7ea>',
            src: 'Hello, world!',
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
